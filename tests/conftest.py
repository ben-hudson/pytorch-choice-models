# conftest.py is a special configuration file for pytest
# It is used to define fixtures, hooks, and other configurations that are shared across multiple test files
